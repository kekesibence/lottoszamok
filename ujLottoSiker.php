<?php
 ...
 if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(empty($_POST['ujElsoSzam'])) {
         $elsoSzamHiba = true;
         $elsoSzamHibaUzenet = "Nem lehet üres a név mező";
    ...
    if(empty($_POST['ujMasodikSzam'])) {
        ...
        $masodikSzamHibaUzenet = "Nem lehet üres a név mező";
    ...
    if(empty($_POST['ujHarmadikSzam'])) {
        ...
        $harmadikSzamHibaUzenet = "Nem lehet üres a név mező";
    ...
    if(empty($_POST['ujNegyedikSzam'])) {
        ...
        $negyedikSzamHibaUzenet = "Nem lehet üres a név mező";
    ...
    if(empty($_POST['ujOtodikSzam'])) {
        $otodikSzamHiba = true;
        $otodikSzamHibaUzenet = "Nem lehet üres a név mező";
...
<div class=container>
    ...
    <form method="POST"> 
        <div class="container row justify-content-center elem">
            ...
            <h2>Sikeres szelvényfelvétel!</h2>
        </div>
    </form>
